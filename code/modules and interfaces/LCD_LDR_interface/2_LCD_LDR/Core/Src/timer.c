...
void init_TIM2_for_delay(void) {
    ...
    TIM2->PSC = CLOCKSPEED / 1000 - 1;   // Prescaler for 1 ms tick
    TIM2->ARR = 0xFFFF;                   // Max ARR for continuous counting

    TIM2->CNT = 0;                       // Reset counter
    TIM2->EGR = TIM_EGR_UG;               // Reload PSC and ARR
    TIM2->SR = 0;                         // Clear status flags
