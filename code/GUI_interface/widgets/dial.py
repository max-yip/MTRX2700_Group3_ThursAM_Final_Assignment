...
class ColorfulDial(QDial):
    def __init__(self, parent=None):
        ...
        self.dial_color = QColor(0, 255, 0)  # Default color (green)

    def setDialColor(self, color):
        """Set the color of the dial."""
        self.dial_color = QColor(color)
    ...
    def paintEvent(self, event):
        ...
        painter.setBrush(QBrush(self.dial_color))  # Use the dynamic color
